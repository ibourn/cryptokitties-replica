...
module.exports = async function (deployer, networks, accounts) {
  ...
  // console.log("***\n TEST get the address of the rental contract of tokenId 2" +
  // "and set this contract as approved for mumId of account 1\n***");
  ...
  // console.log("***\n TEST f/breed from rental contract : dad:2 (borrower: acc1)/ mum:3 (owner: acc1)\n***");
  // let rentInstance = await KittyRental.at(rentalContractAddOfToken2);
  // await rentInstance.consumeAction(2, 3, {from: accounts[1]});

  // kittiesOfacc1 = await kitty.getKittiesOf(accounts[1]);
  // // let owner6 = await kitty.ownerOf(6);
  // // console.log(accounts[1], owner6, rentalContractAddOfToken2);
  // console.log("***\n TEST result : list of the kitties of account 1 :" + kittiesOfacc1 + "\n***");
